...
public:
	...
	virtual void sum(size_t idx) override;  //—”ћћј -> доп.функционал

	//--------------------
	//int sum(size_t idx); //вывод суммы ≈® —ƒ≈ЋјЋј ¬»–“”јЋ№Ќќ…...

	class ConstForwardIterator //дл€ перебора и чтобы ссылатьс€ по индексу
	{
	private:
		LinkedElement* _ptr;
	public:
